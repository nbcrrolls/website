...
<form action="<?php print $webForm; ?>" method="post" name="Collaborator-Part1" target="_self" id="Collaborator-Part1">
  ...
  <tr valign="top">
    <td>
      ...
      <table border="0" cellpadding="1" cellspacing="2">
        <tr>
          <td width="100" class="fieldDescription">First Name <span class="star">*</span></td>
          <td><input name="app_first_name" type="text" class="<?php setInputStyle('app_first_name'); ?>" 
                     value="<?php setInputValue('app_first_name'); ?>" size="30" /></td>
          <td width="100" class="fieldDescription">Last Name <span class="star">*</span></td>
          <td><input name="app_last_name" type="text" class="<?php setInputStyle('app_last_name'); ?>" 
                     id="app_last_name" value="<?php setInputValue('app_last_name'); ?>" size="30" /></td>
        </tr>
        ...
        <tr>
          ...
          <td><input name="app_email" type="text" class="<?php setInputStyle('app_email'); ?>" id="app_email" 
                     value="<?php setInputValue('app_email'); ?>" size="30" maxlength="30" /></td>
          ...
          <td><input name="app_phone" type="text" class="<?php setInputStyle('app_phone'); ?>" id="app_phone" 
                     value="<?php setInputValue('app_phone'); ?>" size="30"/></td>
        </tr>
        ...
        <tr>
          ...
          <td><input name="app_fax" type="text" class="<?php setInputStyle('app_fax'); ?>" id="app_fax" 
                     value="<?php setInputValue('app_fax'); ?>" size="30" /></td>
        ...
        <tr>
          ...
          <td><select name="app_title" class="<?php setSelectStyle('app_title'); ?>" id="app_title">
            ...
            <td><input name="app_spec_title" type="text" class="<?php setInputStyle('app_spec_title'); ?>" id="app_spec_title" 
                       value="<?php setInputValue('app_spec_title'); ?>" size="30"/></td>
        </tr>
      </table>
    </td>
      ...
      <table border="0" cellpadding="1" cellspacing="2">
        ...
        <tr>
          ...
          <td><input name="pi_spec_title" type="text" class="<?php setInputStyle('pi_spec_title'); ?>" id="pi_spec_title" 
                     value="<?php setInputValue('pi_spec_title'); ?>" size="30"/></td>
        </tr>
      </table>
    </td>
  </tr>
    ...
    <table border="0" cellspacing="2" cellpadding="1">
      <tr>
        ...
        <td><input name="institution" type="text" class="<?php setInputStyle('institution'); ?>" id="institution" 
                   value="<?php setInputValue('institution'); ?>" size="50" /></td>
      </tr>
      <tr>
        ...
        <td><input name="department" type="text" class="<?php setInputStyle('department'); ?>" id="department" 
                   value="<?php setInputValue('department'); ?>" size="50" /></td>
      </tr>
      <tr>
        ...
        <td><input name="lab" type="text" class="<?php setInputStyle('lab'); ?>" id="lab" 
                   value="<?php setInputValue('lab'); ?>" size="50" /></td>
      </tr>
      <tr>
        ...
        <td><input name="research_area" type="text" class="<?php setInputStyle('research_area'); ?>" id="research_area" 
                   value="<?php setInputValue('research_area'); ?>" size="50" /></td>
      </tr>
    </table>
    </td>
     ...
     <table border="0" cellpadding="1" cellspacing="2" >
       <tr>
         <td width="35%" class="fieldDescription">Address Line 1 <span class="star">*</span></td>
         <td colspan="3"><input name="street1" type="text" class="<?php setInputStyle('street1'); ?>" id="street1" 
                                value="<?php setInputValue('street1'); ?>" size="90" /></td>
       </tr>
       <tr>
         <td class="fieldDescription">Address Line 2</td>
         <td colspan="3"><input name="street2" type="text" class="field" id="street2" 
                                value="<?php setInputValue('street2'); ?>" size="90" /></td>
       </tr>
       <tr>
         <td width="35%" class="fieldDescription">City <span class="star">*</span></td>
         <td width="21%"><input name="city" type="text" class="<?php setInputStyle('city'); ?>" id="city" 
                    value="<?php setInputValue('city'); ?>" size="40" /></td>
         <td width="15%" class="fieldDescription">State <span class="star">*</span></td>
       ...
       <tr>
         ...
         <td><input name="province" type="text" class="<?php setInputStyle('province'); ?>" id="province" 
                    value="<?php setInputValue('province'); ?>" size="40" /></td>
         ...
         <td><input name="zip" type="text" class="<?php setInputStyle('zip'); ?>" id="zip" 
                    value="<?php setInputValue('zip'); ?>" size="26" /></td>
       </tr>
       <tr>
  ...
  <tr valign="top">
    ...
    <td>
      ...
      <table border="0" cellspacing="2" cellpadding="1">
        <tr>
          <td width="125" class="fieldDescription">Title <span class="star">*</span></td>
          <td><input name="project_title" type="text" class="<?php setInputStyle('project_title'); ?>" id="project_title" size="50" 
                     value="<?php setInputValue('project_title'); ?>" /></td>
        </tr>
        <tr>
          <td class="fieldDescription">Keywords <span class="star">*</span></td>
          <td><input name="keywords" type="text" class="<?php setInputStyle('keywords'); ?>" id="keywords" size="50" 
  ...
  <tr valign="top">
    <td >
      ...
      <table border="0" cellspacing="2" cellpadding="1">
        ...
        <tr>
          <td><textarea name="abs_sum" cols="60" rows="12" class="<?php setInputStyle('abs_sum'); ?>" id="abs_sum">
    ...
    <td >
      ...
      <table border="0" cellspacing="2" cellpadding="1">
        ...
        <tr>
          <td><textarea name="full_sum" cols="60" rows="12" class="<?php setInputStyle('full_sum'); ?>" id="full_sum">
  ...
  <tr valign="top">
    ...
    <td>
      ...
      <table border="0" cellspacing="2" cellpadding="1" <?php setPersonnelSection(); ?>>
        <tr>
          <td  class="fieldDescription">Will you provide personnel? <span class="star">*</span></td>
    ...
    <td colspan="2">
     ...
     <table border="0" cellspacing="2" cellpadding="1">
      ...
      <tr>
        ...
        <td><input size="25" name="grant1" type="text" class="<?php setInputStyle('grant1'); ?>" id="grant1" 
                   value="<?php setInputValue('grant1'); ?>" /></td>
        <td><input size="25" name="pi_first_name1" type="text" class="<?php setInputStyle('pi_first_name1'); ?>" id="pi_first_name1" 
                   value="<?php setInputValue('pi_first_name1'); ?>" /></td>
        <td><input size="35" name="pi_last_name1" type="text" class="<?php setInputStyle('pi_last_name1'); ?>" id="pi_last_name1" 
                   value="<?php setInputValue('pi_last_name1'); ?>"/></td>
        <td><input size="55" name="title1" type="text" class="<?php setInputStyle('title1'); ?>" id="title1" 
      ...
      <tr>
        ...
        <td><input size="25" name="grant2" type="text" class="field" id="grant2" value="<?php setInputValue('grant2'); ?>" /></td>
        <td><input size="25" name="pi_first_name2" type="text" class="field" id="pi_first_name2" 
                   value="<?php setInputValue('pi_first_name2'); ?>" /></td>
        <td><input size="35" name="pi_last_name2" type="text" class="field" id="pi_last_name2" 
                   value="<?php setInputValue('pi_last_name2'); ?>" /></td>
        <td><input size="55" name="title2" type="text" class="field" id="title2" value="<?php setInputValue('title2'); ?>" /></td>
      ...
      <tr>
        ...
        <td><input size="25" name="grant3" type="text" class="field" id="grant3" value="<?php setInputValue('grant3'); ?>" /></td>
        <td><input size="25" name="pi_first_name3" type="text" class="field" id="pi_first_name3" 
                   value="<?php setInputValue('pi_first_name3'); ?>" /></td>
        <td><input size="35" name="pi_last_name3" type="text" class="field" id="pi_last_name3" 
                   value="<?php setInputValue('pi_last_name3'); ?>" /></td>
        <td><input size="55" name="title3" type="text" class="field" id="title3" value="<?php setInputValue('title3'); ?>" /></td>
      ...
      <tr>
        ...
        <td><input size="25" name="grant4" type="text" class="field" id="grant4" value="<?php setInputValue('grant4'); ?>" /></td>
        <td><input size="25" name="pi_first_name4" type="text" class="field" id="pi_first_name4" 
                   value="<?php setInputValue('pi_first_name4'); ?>" /></td>
        <td><input size="35" name="pi_last_name4" type="text" class="field" id="pi_last_name4" 
                   value="<?php setInputValue('pi_last_name4'); ?>" /></td>
        <td><input size="55" name="title4" type="text" class="field" id="title4" value="<?php setInputValue('title4'); ?>" /></td>
      ...
      <tr>
        ...
        <td><input size="25" name="grant5" type="text" class="field" id="grant5" value="<?php setInputValue('grant5'); ?>" /></td>
        <td><input size="25" name="pi_first_name5" type="text" class="field" id="pi_first_name5" 
                   value="<?php setInputValue('pi_first_name5'); ?>" /></td>
        <td><input size="35" name="pi_last_name5" type="text" class="field" id="pi_last_name5" 
                   value="<?php setInputValue('pi_last_name5'); ?>" /></td>
        <td><input size="55" name="title5" type="text" class="field" id="title5" value="<?php setInputValue('title5'); ?>" /></td>
  ...
  <tr>
    <td colspan="2">
      ...
      <tr>
        ...
        <td><textarea name="publication1" cols="60" rows="5" class="<?php setInputStyle('publication1'); ?>" 
        ...
        <td><textarea name="publication4" cols="60" rows="5" class="field" 
      ...
      <tr>
        ...
        <td><textarea name="publication2" cols="60" rows="5" class="<?php setInputStyle('publication2'); ?>" 
        ...
        <td><textarea name="publication5" cols="60" rows="5" class="field" 
      ...
      <tr>
        ...
        <td><textarea name="publication3" cols="60" rows="5" class="<?php setInputStyle('publication3'); ?>" 
