...
Also involved in developing hands-on tutorials for new users of TSRIs established tools, 
as well as new tutorials for new tools.';
$nbcr_role = 'AutoDock Tutorial Instructor';
$photo = 'rhuey.png';
$home_url = '';
$email = 'mailto:rhuey@scripps.edu';
?>
